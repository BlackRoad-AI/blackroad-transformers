...
class MiniMaxM2IntegrationTest(unittest.TestCase):
    ...
    def test_small_model_generation(self):
        ...
        model = MiniMaxM2ForCausalLM.from_pretrained(
            "hf-internal-testing/MiniMax-M2-Small", device_map="auto", dtype=torch.float16
        )
